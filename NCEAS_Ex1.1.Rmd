...
# Look at data
Some basic data exploration to look at normality and potential outliers. 
There appears to be some skew. Lets look at different possible transformations to see which looks best. 
```{r}
...
Okay lets try to fit a linear model to this data so that (later) we can calculate unknown biomass from leaf length. 
